...
<div class="container" >
        <div class="row" style="color: red;border-style: outset; background-color:white">
            <div class="col-6" >
                <h1>MoviePlan&copy; </h1> <p>customer page</p>
            </div>
            <div  class="col-6" >
		...
		<c:forEach var="product" items="${products}">
			<div class="row" >
				<div class="col-12"  >
				<h style="border-style:double; color:red;"> Book your tickets below, for shows between 9AM - 12PM</h><br><br>
					<img alt="${product.productName}" src="${product.imageUrl}" width="200px" height="160" >
					
				</div>	
			
				<div>
					 <b>Movie Name:</b>${product.productName} &nbsp&nbsp&nbsp &#x2764; <br>
                    
					<b>Ticket Price:</b>${product.price}  &nbsp <a href="./pay">Book Ticket</a><br>
					<b>Seats Available</b>
				</div>
			</div>
